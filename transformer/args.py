...
def get_setup_args():
    ...
    parser.add_argument('--dev_meta_file',
                        type=str,
                        default='./data/minisample_66/dev_meta.json')
    parser.add_argument('--test_meta_file',
                        type=str,
                        default='./data/minisample_66/test_meta.json')
    parser.add_argument('--word2idx_file',
                        type=str,
                        default='./data/minisample_66/word2idx.json')
    parser.add_argument('--char2idx_file',
                        type=str,
                        default='./data/minisample_66/char2idx.json')
    parser.add_argument('--answer_file',
                        type=str,
                        default='./data/minisample_66/answer.json')
...
def get_train_args():
    ...
    if args.metric_name in ('NLL', 'PPL'):
...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file',
                        type=str,
                        default='./data/minisample_66/train.npz')
    parser.add_argument('--dev_record_file',
                        type=str,
                        default='./data/minisample_66/dev.npz')
    parser.add_argument('--test_record_file',
                        type=str,
                        default='./data/minisample_66/test.npz')
    parser.add_argument('--word_emb_file',
                        type=str,
                        default='./data/minisample_66/word_emb.json')
    parser.add_argument('--char_emb_file',
                        type=str,
                        default='./data/minisample_66/char_emb.json')
    parser.add_argument('--train_eval_file',
                        type=str,
                        default='./data/minisample_66/train_eval.json')
    parser.add_argument('--dev_eval_file',
                        type=str,
                        default='./data/minisample_66/dev_eval.json')
    parser.add_argument('--test_eval_file',
                        type=str,
                        default='./data/minisample_66/test_eval.json')
