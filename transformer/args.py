...
def get_setup_args():
    ...
    parser.add_argument('--dev_meta_file',
                        type=str,
                        default='./data/sample/dev_meta.json')
    parser.add_argument('--test_meta_file',
                        type=str,
                        default='./data/sample/test_meta.json')
    parser.add_argument('--word2idx_file',
                        type=str,
                        default='./data/sample/word2idx.json')
    parser.add_argument('--char2idx_file',
                        type=str,
                        default='./data/sample/char2idx.json')
    parser.add_argument('--answer_file',
                        type=str,
                        default='./data/sample/answer.json')
...
def add_common_args(parser):
    ...
    parser.add_argument('--train_record_file',
                        type=str,
                        default='./data/sample/train.npz')
    parser.add_argument('--dev_record_file',
                        type=str,
                        default='./data/sample/dev.npz')
    parser.add_argument('--test_record_file',
                        type=str,
                        default='./data/sample/test.npz')
    parser.add_argument('--word_emb_file',
                        type=str,
                        default='./data/sample/word_emb.json')
    parser.add_argument('--char_emb_file',
                        type=str,
                        default='./data/sample/char_emb.json')
    parser.add_argument('--train_eval_file',
                        type=str,
                        default='./data/sample/train_eval.json')
    parser.add_argument('--dev_eval_file',
                        type=str,
                        default='./data/sample/dev_eval.json')
    parser.add_argument('--test_eval_file',
                        type=str,
                        default='./data/sample/test_eval.json')
